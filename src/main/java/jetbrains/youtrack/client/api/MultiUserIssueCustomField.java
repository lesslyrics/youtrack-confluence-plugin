 ...
 */
@Schema(description = "Represents the issue custom field of the `user` type that can have multiple values.")
...
public class MultiUserIssueCustomField extends DatabaseMultiValueIssueCustomField {
  @JsonProperty("value")
  private List<User> value = null;

  public MultiUserIssueCustomField value(List<User> value) {
    this.value = value;
    return this;
  }

  public MultiUserIssueCustomField addValueItem(User valueItem) {
    if (this.value == null) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.value, multiUserIssueCustomField.value) &&
        super.equals(o);
  }
  ...
  public String toString() {
    ...
    sb.append("class MultiUserIssueCustomField {\n");
