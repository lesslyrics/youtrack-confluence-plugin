 ...
 */
@Schema(description = "Comment is visible for all the users who can read the issue.")
...
public class CommandUnlimitedVisibility extends CommandVisibility {
  ...
  public String toString() {
    ...
    sb.append("class CommandUnlimitedVisibility {\n");
