 ...
 */
@Schema(description = "Represents the format, in which the period values are displayed to the user.")
...
public class PeriodFieldFormat {
  @JsonProperty("id")
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    PeriodFieldFormat periodFieldFormat = (PeriodFieldFormat) o;
    return Objects.equals(this.id, periodFieldFormat.id) &&
        Objects.equals(this.$type, periodFieldFormat.$type);
  }
  ...
  public String toString() {
    ...
    sb.append("class PeriodFieldFormat {\n");
