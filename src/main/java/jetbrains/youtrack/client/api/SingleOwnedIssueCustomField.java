 ...
 */
@Schema(description = "Represents the issue custom field of the `ownedField` type that can only have a single value.")
...
public class SingleOwnedIssueCustomField extends DatabaseSingleValueIssueCustomField {
  @JsonProperty("value")
  private OwnedBundleElement value = null;

  public SingleOwnedIssueCustomField value(OwnedBundleElement value) {
    this.value = value;
    return this;
  }
  ...
  **/
  @Schema(description = "")
  public OwnedBundleElement getValue() {
    return value;
  }

  public void setValue(OwnedBundleElement value) {
    this.value = value;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.value, singleOwnedIssueCustomField.value) &&
        super.equals(o);
  }
  ...
  public String toString() {
    ...
    sb.append("class SingleOwnedIssueCustomField {\n");
